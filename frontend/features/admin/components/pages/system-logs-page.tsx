...
import { ScrollText, AlertCircle, Loader2, ChevronDown, ChevronRight, Copy, Check } from 'lucide-react';
...
import { getSystemLogs } from '@/features/admin/api';
